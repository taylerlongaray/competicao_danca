    ...
    if st.session_state.jurado_logado is None:
        ...
        if st.session_state.categoria_selecionada is None:
            ...
            if not competidores_qualificados:
                ...
                # Card 2: Competidor com botões Anterior/Próximo (Agora forçados no CSS)
                ...
                with col_ant:
                    ...
                    st.markdown(
                        ...
                        " letter-spacing:2px; margin-top: 4px;'>ANTERIOR</div>",
                        unsafe_allow_html=True,
                    )
                ...
                with col_prox:
                    ...
                    st.markdown(
                        "<div style='text-align:center; color:#8d7a52; font-size:9px;"
                        " letter-spacing:2px; margin-top: 4px;'>PRÓXIMO</div>",
                        unsafe_allow_html=True,
                    )
