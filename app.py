...
st.markdown(
    ...
    /* Estilo para os botões laterais de navegação (Anterior / Próximo) */
    ...
    if st.session_state.jurado_logado is None:
        ...
        if st.session_state.categoria_selecionada is None:
            ...
            if not competidores_qualificados:
                ...
                # Card 2: Competidor com botões Anterior/Próximo nas laterais do nome
                col_ant, col_nome, col_prox = st.columns([1, 6, 1], vertical_alignment="center")
                ...
                with col_nome:
                    st.markdown(
                        f"""
                        <div class="jj-card jj-avaliando" style="margin-bottom: 0; padding: 12px 16px;">
